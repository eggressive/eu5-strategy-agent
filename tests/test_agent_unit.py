...
class TestToolExecution:
    ...
    def test_execute_tool_call_knowledge(self, temp_knowledge_base, monkeypatch, sample_tool_call):
        ...
        agent = EU5Agent()
        tool_call = sample_tool_call("query_knowledge", '{"category": "mechanics", "subcategory": "economy"}')
    ...
    def test_execute_tool_call_unknown_tool(self, temp_knowledge_base, monkeypatch, sample_tool_call):
...
class TestChatFunctionality:
    ...
    def test_chat_with_tool_calls(self, temp_knowledge_base, monkeypatch, mock_openai_response, sample_tool_call):
    ...
    def test_chat_max_iterations(self, temp_knowledge_base, monkeypatch, mock_openai_response, sample_tool_call):
    ...
    def test_chat_verbose_mode(self, temp_knowledge_base, monkeypatch, mock_openai_response, caplog):
...
class TestAgentIntegration:
    ...
    def test_full_chat_workflow(self, temp_knowledge_base, monkeypatch):
        ...
        mock_response.choices[0].message.model_dump = Mock(return_value={
            "role": "assistant",
            "content": "Test answer"
        })
    ...
    def test_reset_between_conversations(self, temp_knowledge_base, monkeypatch, mock_openai_response):
