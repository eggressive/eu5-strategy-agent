...
- Requesting territorial concessions
...
- Can create chains of obligations

**Strategic Use**: Build favors with key allies before major wars.
...
- Countries must have **similar Great Power Score**
- Must have **negative opinion** of target
- Cannot rival allies or subjects
...
- Nations won't join if they have their own conflicts
...
- Dissolves if antagonism decreases
...
- Return provinces to reduce antagonism
- Build truces between conquests
...
**Alliance Proposals**: Form defensive pact
**Royal Marriage**: Dynastic ties (monarchies only)
**Military Access**: Allow troop passage
**Trade Agreement**: Economic cooperation
**Guarantee Independence**: Protect smaller nations
**Vassalization**: Make country your subject

### Hostile Actions

**Declare Rivalry**: Mark as enemy
**Embargo**: Block trade
**Fabricate Claims**: Create casus belli
**Support Rebels**: Destabilize target
**Intervene in War**: Join enemy's war
...
- Government power for major actions

## Diplomatic Strategy

### Early Game

1. Secure one strong ally
2. Avoid early rivalries
3. Build opinion with neighbors
4. Establish trade agreements

### Mid Game

1. Manage antagonism carefully
2. Build favor network
3. Form strategic rivalries
4. Join or lead organizations

### Late Game

1. Maintain coalition deterrence
2. Use favors for major wars
3. Manage complex alliance networks
4. Leverage international organizations

### Common Pitfalls

1. **Ignoring antagonism**: Triggers coalitions
2. **Breaking alliances carelessly**: Ruins reputation
3. **Over-rivaling**: Too many enemies
4. **Neglecting favors**: Can't call allies when needed
5. **Poor capacity management**: Can't form needed relations
