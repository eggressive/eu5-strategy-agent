...
- Focus selection determines available advances
- More flexible, less linear progression
...
1. **Age of Traditions** (1337-1342)
2. **Age of Renaissance** (1342-1442)
3. **Age of Discovery** (1442-1542)
4. **Age of Reformation** (1542-1642)
5. **Age of Absolutism** (1642-1742)
6. **Age of Revolutions** (1742-1842)
...
- Unlock new technologies and capabilities
...
- Development level affects spread speed
- Trade connections facilitate spread
...
- Affects research costs for associated advances
...
4. **Enables new buildings and units**
...
- Prioritize institutions relevant to your strategy
...
- Must be embraced to access advanced technologies
...
- Strategic: Store progress while deciding next advance

### Focus Selection

**At the start of each age, countries select one of three focuses**:

1. **Administrative Ability** (Paper icon)
2. **Diplomatic Ability** (Dove icon)
...
- **Balance**: Vary focus across ages for well-rounded nation
...
- Store research progress before age change
...
- "Drill Army" requires advance with same name
...
- Military quality over quantity
...
- Unique opportunity (e.g., colonization window)
...
- Help institutions spread to provinces
...
- Conquer provinces with high institution presence
...
- Military pressure: Keep them in wars (war exhaustion slows progress)
...
- Age 3: Diplomatic (consolidation)
