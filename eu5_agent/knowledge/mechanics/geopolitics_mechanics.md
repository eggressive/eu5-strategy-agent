...
- Market assignment based on two competing forces:
  - **Market Attraction**: Pull toward closest/most developed market
  - **Market Protection**: Policies to keep markets within your control
...
- Every pop participates in market economy
...
- Control over markets = control over trade revenue
...
- **Geopolitics**: Market control influences power projection
...
- CBs are temporary and expire

### Three Methods to Obtain Casus Belli
...
- **Reconquest**: Only available for land you previously owned (requires cores)

**Cost**: 20 Spy Network progress
...
- May grant multiple CBs simultaneously
...
- Additional **20 Righteousness or Karma** (if religion uses resource)
- Generally not recommended except in emergencies
...
- Use Parliament for controversial wars
...
- Faster integration
- Less coalition risk
- Cheaper in terms of diplomatic penalties
...
4. Colony grows as more pops arrive
...
- Extended by:
  ...
  - Maritime ideas
  - Trade offices in distant regions
...
- Can build buildings and develop
...
- Target uncontested regions when possible
...
- Enables easier colonization of diverse regions
...
- Maintain colonial control through naval superiority
...
- Ability to pressure weaker nations
...
- Defeating rivals in wars
- High prestige and great power status
- Military technology advantage

## Great Power System

The **9 countries with highest Great Power Score** become Great Powers.
...
- **Stability**: Political cohesion
- **Prestige**: International reputation
- **Government Power**: Administrative capacity
- **Markets**: Economic control
- **Trade Routes**: Commercial reach
- **Navy**: Naval strength
- **Allies**: Diplomatic connections
- **Army**: Military power
...
- Encourages integration of strong subjects
...
- Build allies and trade networks
...
- Leverage status for diplomatic gains
...
- Build Marketplaces in key locations
...
- Time wars around CB expiration
...
4. Support colonial charters in races
...
- Abandoning colonies before 1,000 population
...
- Leverage subject Great Power Score transfer
...
- Markets determine trade flow and income
- Colonial charters require population migration
- Great Power Score includes economic factors
- Power projection enables economic expansion abroad

### Diplomatic Integration

- CBs through Parliament require estate satisfaction
- Great Powers have special diplomatic actions
- Subjects transfer Great Power Score
- Rivalries affect power projection

### Military Integration

- War declarations require CBs
- Control system affects manpower
- Great Power Score includes military strength
- Power projection influenced by navy
